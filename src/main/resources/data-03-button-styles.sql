...
VALUES ('bdfc7632-35c7-4a9c-852c-1a2b3c4d5e6f', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'DefaultBtn', 'Primary Button', '#FFFFFF', '#729af7', 1.0, 1, 1, 'OpenSansRegular', 16.0, 'Bold', 0.0, 'NoWrap', 'None', '16,10', '0', -1.0, -1.0, 44.0, 44.0, 'Fill', 'Center', 'Left,10', '#26c998', 1, 8, 'icon_save.png', 'Primary action button', 'Double tap to activate', CURRENT_TIMESTAMP);

-- Dark Theme - Primary Button
INSERT INTO dotnetmaui_crossplatform_button_style (id, theme_id, style_key, text, text_color, background_color, opacity, is_visible, is_enabled, font_family, font_size, font_attributes, character_spacing, line_break_mode, text_transform, padding, margin, height_request, width_request, min_height_request, min_width_request, horizontal_options, vertical_options, content_layout, border_color, border_width, corner_radius, image_source, semantic_description, semantic_hint, created_at)
VALUES ('cdfc8743-46d8-5b0d-963d-2b3c4d5e6f7a', 'b2c3d4e5-f6a7-8901-bcde-f12345678901', 'DefaultBtn', 'Primary Button', '#FFFFFF', '#729af7', 1.0, 1, 1, 'OpenSansRegular', 16.0, 'Bold', 0.0, 'NoWrap', 'None', '16,10', '0', -1.0, -1.0, 44.0, 44.0, 'Fill', 'Center', 'Left,10', '#26c998', 1, 8, 'icon_save.png', 'Primary action button', 'Double tap to activate', CURRENT_TIMESTAMP);

-- Light Theme - Secondary Button
INSERT INTO dotnetmaui_crossplatform_button_style (id, theme_id, style_key, text, text_color, background_color, opacity, is_visible, is_enabled, font_family, font_size, font_attributes, character_spacing, line_break_mode, text_transform, padding, margin, height_request, width_request, min_height_request, min_width_request, horizontal_options, vertical_options, content_layout, border_color, border_width, corner_radius, image_source, semantic_description, semantic_hint, created_at)
VALUES ('c3dbc5af-6658-4d86-9e11-3c4d5e6f7a8b', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'SecondaryBtn', 'Secondary Button', '#FFFFFF', '#3f733c', 1.0, 1, 1, 'OpenSansRegular', 14.0, 'None', 0.0, 'NoWrap', 'None', '12,8', '0', -1.0, -1.0, 44.0, 44.0, 'Fill', 'Center', 'Left,8', '#444dcf', 1, 4, NULL, 'Secondary action button', 'Double tap to activate', CURRENT_TIMESTAMP);

-- Dark Theme - Secondary Button
INSERT INTO dotnetmaui_crossplatform_button_style (id, theme_id, style_key, text, text_color, background_color, opacity, is_visible, is_enabled, font_family, font_size, font_attributes, character_spacing, line_break_mode, text_transform, padding, margin, height_request, width_request, min_height_request, min_width_request, horizontal_options, vertical_options, content_layout, border_color, border_width, corner_radius, image_source, semantic_description, semantic_hint, created_at)
VALUES ('d4ecd6b0-7769-5e97-0f22-4d5e6f7a8b9c', 'b2c3d4e5-f6a7-8901-bcde-f12345678901', 'SecondaryBtn', 'Secondary Button', '#8c8c8c', '#0e300c', 1.0, 1, 1, 'OpenSansRegular', 14.0, 'None', 0.0, 'NoWrap', 'None', '12,8', '0', -1.0, -1.0, 44.0, 44.0, 'Fill', 'Center', 'Left,8', '#444dcf', 1, 4, NULL, 'Secondary action button', 'Double tap to activate', CURRENT_TIMESTAMP);
