...
VALUES ('9c0d1e2f-3a4b-5c6d-7e8f-9a0b1c2d3e4f', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'DefaultTextEntry', '#FFFFFF', '#1A1A1A', '#9E9E9E', '#007AFF', '#B3D7FF', 16.0, 'OpenSansRegular', 48.0, '0', 'WHILE_EDITING', 'NEXT', 'START', 'CENTER', NULL, 0, NULL, CURRENT_TIMESTAMP);

-- Dark Theme - Default Entry Style
INSERT INTO dotnetmaui_crossplatform_entry_style (id, theme_id, style_key, background_color, text_color, placeholder_color, cursor_color, selection_highlight_color, font_size, font_family, height_request, margin, clear_button_visibility, return_type, horizontal_text_alignment, vertical_text_alignment, keyboard, is_password, max_length, created_at)
VALUES ('0d1e2f3a-4b5c-6d7e-8f9a-0b1c2d3e4f5a', 'b2c3d4e5-f6a7-8901-bcde-f12345678901', 'DefaultTextEntry', '#1E1E1E', '#F5F5F5', '#757575', '#4DA3FF', '#3A5F8A', 16.0, 'OpenSansRegular', 48.0, '0', 'WHILE_EDITING', 'NEXT', 'START', 'CENTER', NULL, 0, NULL, CURRENT_TIMESTAMP);

-- Light Theme - Digit Entry Style
INSERT INTO dotnetmaui_crossplatform_entry_style (id, theme_id, style_key, background_color, text_color, placeholder_color, cursor_color, selection_highlight_color, font_size, font_family, height_request, margin, clear_button_visibility, return_type, horizontal_text_alignment, vertical_text_alignment, keyboard, is_password, max_length, created_at)
VALUES ('1e2f3a4b-5c6d-7e8f-9a0b-1c2d3e4f5a6b', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'DefaultDigitEntry', '#FFFFFF', '#1A1A1A', '#9E9E9E', '#007AFF', '#B3D7FF', 16.0, 'OpenSansRegular', 48.0, '0', 'WHILE_EDITING', 'DONE', 'CENTER', 'CENTER', 'NUMERIC', 0, 10, CURRENT_TIMESTAMP);

-- Dark Theme - Digit Entry Style
INSERT INTO dotnetmaui_crossplatform_entry_style (id, theme_id, style_key, background_color, text_color, placeholder_color, cursor_color, selection_highlight_color, font_size, font_family, height_request, margin, clear_button_visibility, return_type, horizontal_text_alignment, vertical_text_alignment, keyboard, is_password, max_length, created_at)
VALUES ('2f3a4b5c-6d7e-8f9a-0b1c-2d3e4f5a6b7c', 'b2c3d4e5-f6a7-8901-bcde-f12345678901', 'DefaultDigitEntry', '#1E1E1E', '#F5F5F5', '#757575', '#4DA3FF', '#3A5F8A', 16.0, 'OpenSansRegular', 48.0, '0', 'WHILE_EDITING', 'DONE', 'CENTER', 'CENTER', 'NUMERIC', 0, 10, CURRENT_TIMESTAMP);

-- Light Theme - Password Entry Style
INSERT INTO dotnetmaui_crossplatform_entry_style (id, theme_id, style_key, background_color, text_color, placeholder_color, cursor_color, selection_highlight_color, font_size, font_family, height_request, margin, clear_button_visibility, return_type, horizontal_text_alignment, vertical_text_alignment, keyboard, is_password, max_length, created_at)
VALUES ('3a4b5c6d-7e8f-9a0b-1c2d-3e4f5a6b7c8d', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'DefaultPassEntry', '#FFFFFF', '#1A1A1A', '#9E9E9E', '#007AFF', '#B3D7FF', 16.0, 'OpenSansRegular', 48.0, '0', 'NEVER', 'DONE', 'START', 'CENTER', NULL, 1, 128, CURRENT_TIMESTAMP);

-- Dark Theme - Password Entry Style
INSERT INTO dotnetmaui_crossplatform_entry_style (id, theme_id, style_key, background_color, text_color, placeholder_color, cursor_color, selection_highlight_color, font_size, font_family, height_request, margin, clear_button_visibility, return_type, horizontal_text_alignment, vertical_text_alignment, keyboard, is_password, max_length, created_at)
VALUES ('4b5c6d7e-8f9a-0b1c-2d3e-4f5a6b7c8d9e', 'b2c3d4e5-f6a7-8901-bcde-f12345678901', 'DefaultPassEntry', '#1E1E1E', '#F5F5F5', '#757575', '#4DA3FF', '#3A5F8A', 16.0, 'OpenSansRegular', 48.0, '0', 'NEVER', 'DONE', 'START', 'CENTER', NULL, 1, 128, CURRENT_TIMESTAMP);
